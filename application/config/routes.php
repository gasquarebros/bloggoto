...
*/
$route['default_controller'] = 'home/wall';
...
$route['myprofile/products/(.*)'] = 'myprofile/products/$1';
$route['myprofile/services'] = 'myprofile/services';
$route['myprofile/services/(.*)'] = 'myprofile/services/$1';
...
$route['restservices'] = 'restservices/index';
$route['restservices/(.*)'] = 'restservices/$1';
$route['services/(.*)'] = 'services/$1';
$route['checkout'] = 'checkout/index';
$route['checkout/(.*)'] = 'checkout/$1';
$route['manageproducts'] = 'manageproducts/index';
$route['manageproducts/(.*)'] = 'manageproducts/$1';
$route['manageservices'] = 'manageservices/index';
$route['manageservices/(.*)'] = 'manageservices/$1';
$route['mybookings'] = 'mybookings/index';
$route['mybookings/(.*)'] = 'mybookings/$1';
$route['managebookings'] = 'managebookings/index';
$route['managebookings/(.*)'] = 'managebookings/$1';
$route['orders'] = 'orders/index';
$route['orders/(.*)'] = 'orders/$1';
$route['manageorders'] = 'manageorders/index';
$route['manageorders/(.*)'] = 'manageorders/$1';
