...
<?php $i=0; foreach($records as $record) {  ?>
	<li class="list_prod_section item">
		...
		<div class="img_part">
			...
			<a class="main-title" title="<?php echo $record['ser_title']; ?>" href="<?php echo $page_url; ?>"> 
		...
		<div class="cont_part">
			<a class="main-title " title="<?php echo $record['ser_title']; ?>" href="<?php echo $page_url; ?>"><?php echo $record['ser_title']; ?></a> 
...
<div class="more_details_par txtc">
	...
	<?php if($current_records < $total_rows) { ?>
		<a data-nextpage="<?php echo $page+1; ?>" class="common_but lazy_load_flashsale_services load_more"> <span>Show more</span> </a> 
	<?php }  ?>
</div>
<?php
} else if($offset == 0) { ?>
