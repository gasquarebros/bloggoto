							...
							<?php foreach($suggestions as $suggestion) { //echo "<pre>"; print_r($suggestion); exit; ?>
								<li>
									...
									<div class="rgt_txt_fllw">
										<p><a href="<?php echo base_url().urlencode($suggestion['customer_username']); ?>" target="_blank" ><?php echo $suggestion['customer_first_name']." ".$suggestion['customer_last_name']; ?></a></p>
