	...
	?>		
			<div class="comments_records">
				...
				<div class="parent_comments">
					<div class="message"> <span class="arrow"> </span> <a href="<?php echo base_url().'myprofile/'.encode_value($record['customer_id']); ?>" class="name"> <?php echo $record['customer_first_name']." ".$record['customer_last_name']; ?> </a> <span class="datetime"> at <?php echo date('Y-m-d H:i:s',strtotime($record['post_comment_created_on'])); ?> </span> <span class="body"> <?php echo $record['post_comment_message']; ?> </span> </div>
