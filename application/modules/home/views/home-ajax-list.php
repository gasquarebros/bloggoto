...
<?php if(get_user_id() != '') 
	  { 
?>				
				<a href="javascript:;" class="post_more x_login_popup" title="More"><i class="fa fa-ellipsis-v"></i></a><br>		
				<a href="javascript:;" class="post_report x_login_popup" data-id="<?php echo encode_value($record['post_id']);?>" title="Report"><i class="fa fa-flag-o"></i></a><br>

<?php if(get_user_id() == $record['post_created_by']) 
		{ 
?>				
				<a href="<?php echo base_url().$module.'/editpost/'.$record['post_slug']; ?>" class="post_edit x_login_popup" data-id="<?php echo encode_value($record['post_id']);?>" title="Edit"><i class="fa fa-edit"></i></a><br>				
				<a href="javascript:;" class="post_delete x_login_popup" data-id="<?php echo encode_value($record['post_id']);?>" title="Delete"><i class="fa fa-trash-o"></i></a><br>			
<?php } 
