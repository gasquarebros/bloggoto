	...
	<div class="category_part">
		<div class="container">
			...
			<div class="ship_add_full">
				...
				<div class="ship_add thankyou_page_full">
					<h3 class="txtc">Your Order Confirmation</h3>

					<div class="thank_part txtc">
						<p class="tick "><span class="circle"><i class="fa fa-check" aria-hidden="true"></i></span></p>
						<h2>Thankyou</h2>
						<p class="order_para">Your order has been placed.<br> <span class="order_no_title">Order Number:</span> <span class="order_no"><?php echo $order[0]['order_local_no']; ?></span></p>
					</div>

					<div class="thank_summary_table">

						<div class="thank_order_summary">
							<div class="thank_order_sum_left fl txtl">
								<h6>Your order Summary <span><?php echo count($order); ?> Item</span></h6>
							</div>
							<div class="thank_order_sum_right fl txtr">
								<h6>Amount Received: <span><?php echo show_price($order[0]['order_total_amount']); ?></span></h6>
							</div>
							<div class="clear"></div>
						</div>
						<div class="res-table">
							...
							<table>
								<thead>
									<tr>
										...
										<th class="txtc">Quantity</th>
										<th class="txtr">Amount</th>
									</tr>
								</thead>
								<tbody>
									<?php foreach($order as $orderitems) {  ?>
										<tr>
											<td class="pro_name">
												<span class="pro_pic">
													<img src="<?php echo $orderitems['item_image']; ?>" alt="<?php echo $orderitems['item_name']; ?>" />
												</span>
												<p class="desc"><?php echo $orderitems['item_name']; ?></p>
												<p class="merchant">Merchant: <strong><?php echo $orderitems['item_merchant_name']; ?></strong></p>
												<?php if($orderitems['item_subproduct_name'] != '') { ?>
													<p class="subproduct"><?php echo $orderitems['item_subproduct_name']; ?></p>
												<?php } ?>
												<p>
													<?php /*if(!empty($orderitems['item_modifiers'])) { ?>
														<?php foreach($orderitems['item_modifiers'] as $itemodifier) { ?>
														<span class="color"><?php echo $itemodifier['order_modifier_name']; ?>: <strong><?php echo $itemodifier['order_modifier_value_name']; ?></strong></span>
														<?php } ?>
													<?php }*/ ?>
												</p>
											</td>
											<td class="pro_quantity txtc">
												<?php echo $orderitems['item_qty']; ?>
											</td>
											<td class="pro_amount txtr"><strong><?php echo show_price($orderitems['item_total_amount']); ?></strong></td>
										</tr>
									<?php } ?>
								</tbody>
							</table>
						...
						<div class="thank_ship_add">
							<div class="thank_ship_add_left fl">
							</div>
							<div class="thank_ship_add_right fr">
								<table>
									<tbody>
									<tr>
										<th>Subtotal:</th>
										<td class="price"><?php echo show_price($order[0]['order_sub_total']); ?></td>
									</tr>
									<tr>
										<th>Delivery Charge:</th>
										<td class="price"><?php echo show_price($order[0]['order_delivery_charge']); ?></td>
									</tr>
									<tr>
										<th>Total:</th>
										<td class="total"><?php echo show_price($order[0]['order_total_amount']); ?></td>
									</tr>
									</tbody>
								</table>
							</div>
