                        ...
                        <div class="card-body"> 
                            ...
                            <div class="form-group">
                             <?php  $search_array = array(
                             		 '' => get_label('select'),
                                    'order_service_local_no' => get_label('order_service_local_no'),
                             );
                             ...
                             <div class="form-group">
                                <?php 
                             		echo get_service_category($where='',$selected='',$extra='class="form-control" id="service_category" ',$product_id='ser_cate_primary_id');
                             	?>
                            </div> 
