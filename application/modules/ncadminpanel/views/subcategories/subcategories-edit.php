			...
			<div class="col-xs-12">
                ...
                <?php echo form_open_multipart(admin_url().$module."/$module_action",' class="form-horizontal" id="common_form" ' );?>
                        ...
                        <div class="form-group">
							...
							<img data-id="remove_image" class="img-responsive common_delete_other_image" style="width: 250px; height:250px;"  src="<?php echo media_url().get_company_folder()."/". $this->lang->line('product_subcategory_image_folder_name')."/".$records['pro_subcate_image'];?>">
							</a>
							</div><?php } ?>
                        </div>
