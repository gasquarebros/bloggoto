                ...
                <?php echo form_open_multipart(admin_url().$module.'/add',' class="form-horizontal" id="common_form" autocomplete="'.form_autocomplte().'" ' );?>
						<ul class=" alert_msg  alert-danger  alert container_alert" style="display: none;"></ul>
                         ...
                         <div class="form-group">
							...
							<div class="col-sm-<?php echo get_form_size();?>"><div class="input_box"><?php  echo form_input('ser_cate_name',set_value('ser_cate_name'),' class="form-control required"  ');?></div></div>
						</div>
						
				
						<div class="form-group">
							<label for="ser_cate_short_desc" class="col-sm-2 control-label"><?php echo get_label('ser_cate_short_desc');?></label>
							<div class="col-sm-8"><div class="input_box"><?php  echo form_textarea('ser_cate_short_desc',set_value('ser_cate_short_desc'),' class="form-control"  ');?></div></div>
						</div>

						   <div class="form-group">
							<label for="ser_cate_desc" class="col-sm-2 control-label"><?php echo get_label('ser_cate_desc');?></label>
							<div class="col-sm-8"><div class="input_box"><?php  echo form_textarea('ser_cate_desc',set_value('ser_cate_desc'),' class="form-control"   ');?></div></div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-<?php echo get_form_size();?>"><div class="input_box"><?php  echo form_input('ser_cate_sequence',set_value('pro_cate_sequence'),' class="form-control "   ');?></div></div>
						</div>
