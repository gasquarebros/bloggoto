	   ...
	   <?php echo get_template('layout/notifications','')?>
		<div class="page-title">
             ...
             <div class="pull-right">
                    <a href="<?php echo admin_url().$module."/add"?>" class="an_btn " type="button"><span><i class="fa fa-plus"></i></span><?php echo get_label('add');?></a>
            </div>
                        ...
                        <div class="card-body"> 
                            ...
                            <div class="form-group">
                             <?php  $search_array = array(
                             		 '' => get_label('select'),
                             	     'post_title' =>  get_label('post_title'));
							...
							<div class="form-group">
                             <?php 
                             echo form_dropdown('search_category',$post_category,get_session_value($module."_search_category"),'style="width:200px"');
                             ?>
                            </div>
