		...
		<div class="page-title add_sub_breadcrump">
            <div class="tt_left">
                <span class="title"><?php echo $module_labels; ?></span>
                     ...
                     <ul class="pg_categorymenu"> <li class="active"><a href="<?php echo admin_url()."modifiers"?>" ><?php echo get_label('pro_modifier_labels');?></a> </li> <li> <a href="<?php echo admin_url()."modifiervalues"?>"><?php echo get_label('pro_modifier_value_labels');?></a></li></ul>            </div>
                        ...
                        <div class="card-body"> 
                            ...
                            <div class="form-group">
                             <?php  $search_array = array(
                             		 '' => get_label('select'),
                             	     'pro_modifier_name' => get_label('pro_modifier_name'),
                             );
                             
                             echo form_dropdown('search_field',$search_array,'pro_modifier_name','  class="form-control" ');
