...
<tr>
			<td scope="row"><div
					class="checkbox3 checkbox-inline checkbox-check checkbox-light"><?php echo form_checkbox('id[]',$val['product_primary_id'],'',' class="multi_check" type="checkbox" id="'.$val['product_primary_id'].'"   ');?>
 <label for="<?php echo $val['product_primary_id'];?>" class="chk_box_label"></label>
				</div> </td>
	...
	<td> 
	    ...
	    <a href="<?php echo admin_url().$module.'/edit/'.encode_value($val['product_primary_id']);?>"><i class="fa fa-edit" title="<?php echo get_label('edit')?>"></i></a>&nbsp;
