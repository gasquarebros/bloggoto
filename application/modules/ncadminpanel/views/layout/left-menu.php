                        ...
                        <ul class="nav navbar-nav">
                            <li class="active">
                                <a href="<?php echo admin_url()."dashboard"?>">
                                    <span class="icon fa fa-tachometer"></span><span class="title"><?php echo get_label('dashboard_module_label'); ?></span>
                                </a>
                            </li>
                            
                             <li class="active">
                                <a href="<?php echo admin_url()."company"?>">
                                    <span class="icon fa fa-users"></span><span class="title"><?php echo get_label('clinet_module_labels');?></span>
                                </a>
                            </li>
                            
                             <li class="active">
                                <a href="<?php echo admin_url()."usergroups"?>">
                                    <span class="icon fa fa-users"></span><span class="title"><?php echo get_label('user_grp_module_labels');?></span>
                                </a>
                            </li>
                            
                             <li class="active">
                                <a href="<?php echo admin_url()."availability"?>">
                                    <span class="icon fa fa-users"></span><span class="title"><?php echo get_label('av_module_label');?></span>
                                </a>
                            </li>
