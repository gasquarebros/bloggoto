					...
					<div class="card-header">
                        ...
                        <div class="card-body"> 
							...
							<div class="form-group">
								...
								<?php echo $category_array; ?>
							</div>
                            <div class="form-group">
                             <?php  $search_array = array(
                             		 '' => get_label('select'),
                             	     'pro_subcate_name' => get_label('pro_subcate_name'),
                             );

                             echo form_dropdown('search_field',$search_array,'pro_subcate_name',' style="width:150px  !important; " ');
