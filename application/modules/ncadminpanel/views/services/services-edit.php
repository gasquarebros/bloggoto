			...
			<div class="col-xs-12">
                ...
                <?php echo form_open_multipart(admin_url().$module."/$module_action",' class="form-horizontal" id="common_form" ' );?>
						...
						<div class="form-group">
							...
							<div class="col-sm-8"><div class="input_box"><?php echo form_dropdown('ser_pricet_type',array('day'=>'Day','hour'=>'Hour','per session'=>'Per Session','per visit'=>'Per visit'),$records['ser_pricet_type'],'class="form-control required" id="ser_pricet_type"'); ?></div></div>
						</div>
