			...
			<div class="col-xs-12">
                ...
                <?php echo form_open_multipart(admin_url().$module."/$module_action",' class="form-horizontal" id="common_form" ' );?>
                         <div class="form-group">
						   ...
						   <div class="form-group">
							<label for="inputEmail3" class="col-sm-2 control-label"><?php echo get_label('pro_cate_short_desc');?></label>
							<div class="col-sm-8"><div class="input_box"><?php  echo form_textarea('pro_cate_short_desc',stripslashes($records['pro_cate_short_description']),' class="form-control"  ');?></div></div>
						</div>
						
						   <div class="form-group">
							<label for="inputEmail3" class="col-sm-2 control-label"><?php echo get_label('pro_cate_desc');?></label>
							<div class="col-sm-8"><div class="input_box"><?php  echo form_textarea('pro_cate_desc',stripslashes($records['pro_cate_description']),' class="form-control"   ');?></div></div>
						</div>
						
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-2 control-label"><?php echo get_label('pro_cate_image');?></label>
							<div class="col-sm-4"> <div class="input_box"> <div class="custom_browsefile"> <?php echo form_upload('pro_cate_image');?> <span class="result_browsefile"><span class="brows"></span>+ <?php echo get_label('upload_image');?></span> </div> </div> </div>
                            							
						</div>
                        <div class="form-group">
                             <?php if($records['pro_cate_image']){ ?>
							...
							<img data-id="remove_image" class="img-responsive common_delete_other_image" style="width: 250px; height:250px;"  src="<?php echo media_url().get_company_folder()."/". $this->lang->line('product_category_image_folder_name')."/".$records['pro_cate_image'];?>">
							</a>
							</div><?php } ?>
                        </div>
						...
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-2 control-label"><?php echo get_label('pro_cate_sequence');?></label>
							<div class="col-sm-<?php echo get_form_size();?>"><div class="input_box"><?php  echo form_input('pro_cate_sequence',stripslashes($records['pro_cate_sequence']),' class="form-control "   ');?></div></div>
						</div>
						<?php /*						
						...
						*/ ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-<?php echo get_form_size();?>"><div class="input_box"><?php  echo get_status_dropdown($records['pro_cate_status'],'','class="required" style="width:374px;" ');;?></div></div>
						</div>
