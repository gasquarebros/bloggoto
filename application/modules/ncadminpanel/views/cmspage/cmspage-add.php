	...
	<div class="side-body">
		...
		<div class="row">
			<div class="col-xs-12">
                ...
                <?php echo form_open_multipart(camp_url().$module.'/add',' class="form-horizontal" id="common_form" autocomplete="'.form_autocomplte(). '"' );?>
                         <div class="form-group">
							<label for="cms_title" class="col-sm-2 control-label"><?php echo get_label('cms_title').get_required();?></label>
							<div class="col-sm-<?php echo get_form_size();?>"><div class="input_box"><?php  echo form_input('cms_title',set_value('cms_title'),' class="form-control required"  ');?></div></div>
						</div>
						
                         <div class="form-group">
							<label for="cms_description" class="col-sm-2 control-label"><?php echo get_label('cms_description');?></label>
							<div class="col-sm-<?php echo get_form_editor_size();?>"><div class="input_box"><?php echo form_textarea('cms_description',set_value('cms_description'),'class="" id="email_template" rows="5" cols="200"'); ?></div></div>
						</div>
						
						<div class="form-group">
							<label for="cms_description_mobile" class="col-sm-2 control-label"><?php echo get_label('cms_description_mobile');?></label>
							<div class="col-sm-<?php echo get_form_editor_size();?>"><div class="input_box"><?php echo form_textarea('cms_description_mobile',set_value('cms_description_mobile'),' id="cms_description_mobile" rows="5" cols="200"'); ?></div></div>
						</div>   
						 
                         <div class="form-group">
							<label for="cms_meta_title" class="col-sm-2 control-label"><?php echo get_label('cms_meta_title');?></label>
							<div class="col-sm-<?php echo get_form_size();?>"><div class="input_box"><?php  echo form_input('cms_meta_title',set_value('cms_meta_title'),' class="form-control"  ');?></div></div>
						</div>
						
                         <div class="form-group">
							<label for="cms_meta_keyword" class="col-sm-2 control-label"><?php echo get_label('cms_meta_keyword');?></label>
							<div class="col-sm-<?php echo get_form_size();?>"><div class="input_box"><?php  echo form_input('cms_meta_keyword',set_value('cms_meta_keyword'),' class="form-control"  ');?></div></div>
						</div>
						
                         <div class="form-group">
							<label for="cms_meta_description" class="col-sm-2 control-label"><?php echo get_label('cms_meta_description');?></label>
							<div class="col-sm-<?php echo get_form_editor_size();?>"><div class="input_box"><?php echo form_textarea('cms_meta_description',set_value('cms_meta_description'),'class="form-control" id="cmspage_meta_description"'); ?></div></div>
						</div>
