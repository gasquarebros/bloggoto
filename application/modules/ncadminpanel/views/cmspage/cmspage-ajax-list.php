...
<tr>
			...
			<td><a href="javascript:;"><?php echo show_status($val['cmspage_status'],$val['cmspage_id']);?></a></td>
			<td><?php echo get_date_formart(($val['cmspage_created_on']));?></td>
			<td><a href="<?php echo admin_url().$module.'/edit/'.encode_value($val['cmspage_id']);?>"><i
