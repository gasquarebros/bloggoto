				...
				if ($check_details)
				{
					if ($check_details['customer_status'] == 'A'){
						...
						if($password_verify == "Yes")
						{
							...
							$session_datas = array('bg_user_id' => $check_details['customer_id'],'bg_first_name' => $check_details['customer_first_name'],'bg_last_name' => $check_details['customer_last_name'],'bg_user_email'=>$check_details['customer_email'],'bg_user_group' => ($check_details['customer_type'] == 0)?'writer':'brand','bg_user_type'=>$check_details['customer_type'],'company_name'=>$check_details['company_name'],'customer_username'=>$check_details['customer_username']);
