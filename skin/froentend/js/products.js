				...
				jQuery.ajax({
					...
					success: function (responses) 
					{
						if(responses.status == 'success')
						{
							...
							jQuery('.add_cart').css('disabled',true);
							jQuery('.add_cart').css('opacity',0);
						}
